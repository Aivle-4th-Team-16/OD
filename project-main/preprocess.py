...
log_dir = f"./project-main/logs/{model_name}"
os.makedirs(log_dir, exist_ok=True)
print(f"{log_dir} 디렉토리가 생성되었습니다.")
with open(f'./project-main\logs\{model_name}\preprocess.log','w') as f:
    print("Starting...")
    
# 명령어와 매개변수 설정
command = [
    "python",
    "project-main/infer/modules/train/preprocess.py",
    dataset_folder,
    "40000",
    "2",
...
with open(f'./project-main/logs/{model_name}/preprocess.log','r') as f:
